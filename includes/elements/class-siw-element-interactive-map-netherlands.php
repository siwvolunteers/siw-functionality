 ...
 * */
class SIW_Element_Interactive_Map_Netherlands extends SIW_Element_Interactive_Map {
	 ...
	 * @return string
	 */
	protected function generate_project_description( array $project, bool $project_code = false ) {
		//Verzamelen gegevens
		...
		return SIW_Formatting::array_to_text( $description, BR );
	}
