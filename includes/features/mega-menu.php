...
class Mega_Menu extends Base {
	...
	public function enqueue_styles() {
		...
		wp_register_style( self::ASSETS_HANDLE, SIW_ASSETS_URL . 'css/features/mega-menu.css', [], SIW_PLUGIN_VERSION, "(min-width: {$min_width}px)" );
		// TODO: bug melden omdat wp_maybe_inline_styles() media query niet overneemt
		// wp_style_add_data( self::ASSETS_HANDLE, 'path', SIW_ASSETS_DIR . 'css/features/mega-menu.css.css' );
