...
add_filter( 'caldera_forms_get_form-begeleider_np', function( $form ) {
	...
	$signature = siw_get_option( 'camp_leader_email_signature' );
	/*E-mail bevestiging*/
...
return array(
	...
	array(
		...
		array(
			...
			array(
				...
				'sender_email' => siw_get_option( 'camp_leader_email_sender' ),
	...
	array(
		...
		'reply_to' => '%email%',
		'email_type' => 'html',
		'recipients' => siw_get_option( 'camp_leader_email_sender' ),
