...
add_filter( 'caldera_forms_get_form-contact_project', function( $form ) {
	...
	$signature = siw_get_option( 'enquiry_workcamp_email_signature' );
	/*E-mail bevestiging*/
...
return array(
	...
	array(
		...
		array(
			...
			array(
				...
				'sender_email' => siw_get_option( 'enquiry_workcamp_email_sender' ),
	...
	array(
		...
		'reply_to' => '%emailadres%',
		'email_type' => 'html',
		'recipients' => siw_get_option( 'enquiry_workcamp_email_sender' ),
