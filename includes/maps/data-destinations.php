...
register_map( 'destinations', __( 'Bestemmingen', 'siw' ), 'world' );
...
add_filter( 'siw_map_destinations_data', function( $map_data ) {
    ...
    /* Zet de continenten als categorieën */
    /*
    ...
    */
    ...
    foreach ( $countries as $country ) {
        ...
        $location = [
            ...
            'description'   => generate_country_description( $country ),
        ];      
 ...
 * @return string
 */
function generate_country_description( $country ) {
