<?php
/**
 * Referentiegegevens | Configuratie
 * 
 * @author      Maarten Bruna
 * @package 	SIW\Reference-Data
 * @copyright   Copyright (c) 2018, SIW Internationale Vrijwilligersprojecten
 */
...
//require_once( __DIR__ . '/class-siw-configuration.php' );
...
function siw_configuration_page() {
	...
	<tbody>
	<?php
	$constants = siw_get_configuration();
	$alternate = false;
...
/**
 * Geeft array met configuratie-constantes terug
 *
 * @return array
 */
function siw_get_configuration() {
	$constants = [
...
/* Organisatiegegevens TODO:verplaatsen naar static class */

/** Naam */
define( 'SIW_NAME', 'SIW Internationale Vrijwilligersprojecten' );
...
define( 'SIW_MAX_BOARD_MEMBERS', 9 );
...
define( 'SIW_TRAVEL_ADVICE_BASE_URL', 'https://opendata.nederlandwereldwijd.nl/v1/sources/nederlandwereldwijd/infotypes/traveladvice/' );
