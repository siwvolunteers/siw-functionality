...
add_action('siw_settings_show_workcamps_section', 'siw_settings_show_workcamps_section');
function siw_settings_show_workcamps_section( $opt_name ){
	/*
	Velden
	*/
