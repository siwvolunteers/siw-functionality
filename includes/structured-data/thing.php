...
abstract class Thing {
	...
	/** Zet eigenschap */
	protected function set_property( string $property,  string|Thing|\DateTime|Enum $value ): static {
		$this->data[ $property ] = $this->parse_value( $value );
		return $this;
	}

	/** Voeg eigenschap toe */
	protected function add_property( string $property, string|Thing|\DateTime|Enum $value ): static {
	...
	/** Parset waarde */
	protected function parse_value( string|Thing|\DateTime|Enum $value ): string|array|int {
		if ( is_string( $value ) ) {
	...
	private function get_enum_value( Enum $value ): string|int {
		return $value->value;
	}
