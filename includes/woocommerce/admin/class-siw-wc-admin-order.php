...
class SIW_WC_Admin_Order {
	 ...
	 * @param WC_Order $order
	 */
	public function show_terms( $order ) {
		echo '<br class="clear" />';
	 ...
	 * @param WC_Order $order
	 */
	public function show_language_meta( $order ) {  
	 ...
	 * @param WP_Post $post
	 */
	public function process_order_meta( $post_id, $post ) {
	...
	public function add_inline_style() {
		$styles = [
			'#order_data .order_data_column .form-field-wide label' => [
				'display' => 'inline-block'
			],
			'.form-field-wide .woocommerce-help-tip' => [
				'margin-bottom' => '5px',
			] 
		];
