...
add_filter( 'siw_workcamp_description_templates', function( $templates ) {
	...
	$templates[] = [
		...
		__( 'Als vrijwilliger zal je werkzaamheden gaan uitvoeren gericht op {{ work_type }}.', 'siw' ) . BR,
		__( 'Lees snel verder voor meer informatie over de kosten, de werkzaamheden, de accommodatie en projectlocatie.', 'siw' ) . BR,
	...
	$templates[] = [
		...
		__( 'Dit project vindt plaats van {{ dates }} en biedt ruimte aan {{ participants }} deelnemers in de leeftijd van {{ ages }}.', 'siw' ),
		__( 'Jouw werkzaamheden richten zich op {{ work_type }}.', 'siw' ) . BR,
		__( 'Lees snel verder voor meer informatie over het tarief, werk, accommodatie en projectlocatie.', 'siw' ) . BR,
		__( 'Heb je een vraag over dit project?', 'siw' ),
		__( 'Laat je gegevens achter bij "Stel een vraag" en we nemen zo snel mogelijk contact met je op.', 'siw' ),
	];
	$templates[] = [
		...
		__( 'Dit project vindt plaats van {{ dates }} en biedt ruimte aan {{ participants }} deelnemers in de leeftijd van {{ ages }}.', 'siw' ),
		__( 'Je gaat werkzaamheden uitvoeren gericht op {{ work_type }}.', 'siw' ) . BR,
		__( 'Lees snel verder voor meer informatie over het tarief, werk, accommodatie en projectlocatie.', 'siw' ) . BR,
		__( 'Heb je een vraag over dit project?', 'siw' ),
		__( 'Laat je gegevens achter bij "Stel een vraag" en we nemen zo snel mogelijk contact met je op.', 'siw' ),
	];
