...
class WC_Product_Project extends \WC_Product_Simple {
	...
	*/
	...
	public function get_sale_price( $context = 'view' ) {
		return (string) Properties::WORKCAMP_FEE_REGULAR_SALE;
	}

	/** {@inheritDoc} */
	public function get_regular_price( $context = 'view' ) {
		return (string) Properties::WORKCAMP_FEE_REGULAR;
	}
	...
	public function get_date_on_sale_from($context = 'view'): ?\WC_DateTime {
		$start_date = siw_get_option( 'workcamp_sale.start_date' );
		if ( empty( $start_date ) ) {
			return null;
		}
		return \WC_DateTime::createFromFormat( \WC_DateTime::ATOM, $start_date );
	}

	/** {@inheritDoc} */
	public function get_date_on_sale_to($context = 'view'): ?\WC_DateTime {
		$end_date = siw_get_option( 'workcamp_sale.end_date' );
		if ( empty( $end_date ) ) {
			return null;
		}
		return \WC_DateTime::createFromFormat( \WC_DateTime::ATOM, $end_date );
	}
	...
	*/
	...
	/** Zet of dit project geselecteerd is voor de carousel */
	public function set_selected_for_carousel( bool $selected_for_carousel ) {
		$this->set_prop( 'selected_for_carousel', $selected_for_carousel );
	}

	/** Geeft aan of dit project geselecteerd is voor de carousel */
	public function get_selected_for_carousel(): bool {
		return $this->get_prop( 'selected_for_carousel' );
	}

	/** Geeft aan of dit project geselecteerd is voor de carousel */
	public function is_selected_for_carousel(): bool {
		return $this->get_selected_for_carousel();
	}
