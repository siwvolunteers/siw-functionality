							...
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="60%" style="vertical-align:bottom;border-bottom: solid <?= Color::ACCENT->color();?>;font-family:Verdana, normal; color:#666666; font-size:0.95em; font-weight:bold;" align="center">
